...
def run(body: QueryRequest, authorization: str = Header(...)):
    ...
    try:
        ...
        for question in body.questions:
            ...
            context = "\n\n".join(top_chunks)
            prompt = f""" You are a helpful assistant. Use ONLY the following document context to answer the question. Answer the question clearly in a few sentences. Use all the content provided to arrive at your answer.  If there is some information about quantifiable data, include that in your response. In case the information is not available in this document, and the question pertains to medical policy , then use your knowledge available to answer , but while giving these answers DO NOT be prescriptive and start with the phrase ' Based on public information available : ' and end with ' Please do consult experts or your service provider using their contact number'.
